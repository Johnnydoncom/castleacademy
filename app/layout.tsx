...
export const metadata: Metadata = {
  ...
  title: {
    default: "Castle Academy | Premium Training Space Booking, Lekki Lagos",
  ...
  openGraph: {
    title: "Castle Academy | Premium Training Space Booking, Lekki Lagos",
    description:
      "A professional space where great learning happens. Book Nigeria's most comfortable training venue in Lekki, Lagos in minutes.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Castle Academy training room in Lekki, Lagos",
      },
    ],
  },
  twitter: {
